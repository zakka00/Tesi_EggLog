...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Approfondimento della gestione della memoria SD e del relativo \textit{file system};
...
\begin{itemize}
    ...
    le operazioni di lettura, scrittura e trasferimento dei dati dalla memoria SD rappresentavano una
