...
\begin{itemize}
    ...
    \textit{testing}, analisi delle prestazioni e utilizzo di \textit{benchmark}.

    \item \textbf{Analisi del traffico CAN}\\
    l'acquisizione e l'interpretazione dei dati provenienti dalla ECU della moto rappresentavano
    una possibile criticità, in quanto i messaggi presenti sul bus CAN non seguono necessariamente
