...
\subsection{Creazione e calcolo della capacità}
La capacità totale, descritta in
\hyperref[subsec:capacita_superfile]{Capacità del file}, è calcolata
arrotondando per eccesso alla dimensione del \gls{cluster} del volume. In questo
...
\subsection{Scrittura e wraparound}
...
\subsection{Sincronizzazione e finestra di azzeramento}
...
\subsection{Recovery su più livelli}
...
\subsection{Comunicazione dello stato di occupazione}
...
\subsection{Un caso concreto: due task sullo stesso indicatore}
...
\subsection{Livello decisionale}
...
\subsection{Livello di rendering}
...
\subsection{Sorgente autorevole}
...
\subsection{Debounce sul segnale GPS}
...
\subsection{Soglie e parametri di temporizzazione}
...
\subsection{Attivazione mirata del fallback IMU}
...
\subsection{Sospensione esclude il GPS}
...
\subsection{Sospensione disabilitata}
...
\subsection{Un prerequisito: producer in grado di dormire}
...
\subsection{Comandi come valori instradati centralmente}
...
\subsection{Notifica periodica dello stato di sessione}
...
\subsection{Comando RESUME: risincronizzazione dopo la riconnessione BLE}
...
\subsection{Un caso particolare: l'arresto per spazio esaurito}
...
\subsection{Raccolta campioni e filtro duplicati}
...
\subsection{Mediana, deviazione standard e accettazione del gruppo}
...
\subsection{Formula di conversione e scelta del dato da conservare}
...
\subsection{Fan-out non invasivo sul flusso dati}
...
\subsection{Macchina a stati e instradamento dei comandi}
...
\subsection{Soglie di accettazione degli step}
...
\subsection{Uscita anticipata basata sulla stabilità del segnale}
...
\subsection{Step 1 - Posizione dritta}
...
\subsection{Step 2 - Inclinazione a destra}
...
\subsection{Step 3 - Asse longitudinale e salvataggio}
...
\subsection{Gestione degli esiti negativi}
...
\subsection{Problematiche riscontrate e soluzioni} \label{subsec:prob_risc_calib_imu}
...
\subsection{Il caso d'uso: orchestrazione senza conoscenza degli adattatori}
...
\subsection{Adattatore del bus CAN: ascolto passivo}
...
\subsection{Selezione del profilo veicolo}
...
\subsection{Decodifica specifica del veicolo}
...
\subsection{Trasporto dati: advertising BLE broadcast-only}
...
\subsection{Aggiornamento del riferimento, non dello stato React}
...
prossimo frame.
\subsection{Lettura e interpolazione nel ciclo di rendering 3D}
...
\subsection{Elementi testuali a frequenza ridotta}
...
\subsection{Ripartizione dell'occupazione per sensore}
...
\subsection{Stesso componente, azione differente per contesto}
...
\subsection{Impossibilità di chiusura senza azione}
...
\subsection{Scomparsa automatica al reinserimento della microSD}
...
\subsection{Un controllo dedicato per un insieme discreto di valori}
...
\subsection{Codifica esplicita immediatamente prima della scrittura}
