...
\subsubsection{Calcolo della RAM occupata}
...
\subsubsection{Confronto per sensore}
...
\subsubsection{Variazione percentuale tra le due versioni}
...
\subsubsection{Il ruolo del formato di serializzazione}
...
\subsubsection{Un compromesso tra RAM e frequenza di scrittura}
...
\subsubsection{Disabilitazione del magnetometro}
...
\subsubsection{Il momento dell'allocazione conta più della dimensione}
