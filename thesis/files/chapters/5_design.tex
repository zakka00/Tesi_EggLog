...
\begin{itemize}
    ...
    per i quali non è necessaria una frequenza di aggiornamento elevata, continuano invece a leggere lo stesso store tramite hook con frequenza limitata, evitando
     render superflui.
\end{itemize}
